<template>
    <Section 
        anchor="Numbers" 
        title="Why Choose Orion Accounts Manager?" 
        subtitle="We’re just getting started, but our mission is clear: to make League account management simple, secure, and stress-free. Here’s where we are right now:" 
        grid="4"
    >
