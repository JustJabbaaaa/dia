  ...
  <Section anchor="Header" grid="2">
    <div class="header__left">
      ...
      <!-- <div class="header__buttons">
        <NuxtLink to="" class="btn btn-primary" target="_blank">Login</NuxtLink>
        <NuxtLink to="" class="btn btn-secondary--outline" target="_blank">Register</NuxtLink>
      </div> -->
    </div>
    <div class="header__right">
      <NuxtImg src="images/header/notepad.png" class="header__image" alt="Header Image"/>
    </div>
  </Section>
</template>